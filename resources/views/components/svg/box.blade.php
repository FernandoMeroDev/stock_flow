<div {{$attributes}}>
    <svg class="w-full h-full" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="icon" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" transform="translate(64.000000, 34.346667)">
